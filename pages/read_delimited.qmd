...
glass <- as_tibble(read_delim("https://www4.stat.ncsu.edu/online/datasets/glass.data", 
                       delim = ",",
...
```{r}
yeast <- as_tibble(read_table("https://www4.stat.ncsu.edu/online/datasets/yeast.data",
